...
//}
//
//void NavigationMesh::Create(void* pData)
//{
...
//{
//	Vector3 offset;
//	GetComponent<Transform>()->GetPosition(offset);
//	return _navMeshGraph->Intersect(ray, point, offset);
//}
//
//void NavigationMesh::Bake()
//{
//	shared_ptr<MeshRenderer> pRenderer = GetComponent<MeshRenderer>();
//
//	if (!pRenderer) return;
//
//	Vector3 offset;
